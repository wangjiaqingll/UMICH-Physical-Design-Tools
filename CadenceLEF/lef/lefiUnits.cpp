...
void lefiUnits::setDatabase(const char* name, double num) {
  ...
  this->databaseName_ = (char*)malloc(len);
...
void lefiUnits::clear() {
  if (this->databaseName_) free(this->databaseName_);
  this->hasTime_ = 0;
