...
lefiNoiseResistance_Init(lefiNoiseResistance * this)
{
  ...
  this->victims_ = (lefiNoiseVictim **) malloc(sizeof(lefiNoiseVictim *) * 2);
}
				    ...
				    double d)
{
  ...
  if (this->numVictims_ == this->victimsAllocated_) {
    ...
    lefiNoiseVictim **ne = (lefiNoiseVictim **) malloc(sizeof(lefiNoiseVictim *) * max);
...
lefiNoiseEdge_Init(lefiNoiseEdge * this)
{
  ...
  this->resistances_ = (lefiNoiseResistance **) malloc(sizeof(lefiNoiseResistance *) * 2);
}
...
lefiNoiseEdge_addResistance(lefiNoiseEdge * this)
{
  ...
  if (this->numResistances_ == this->resistancesAllocated_) {
    ...
    lefiNoiseResistance **ne = (lefiNoiseResistance **) malloc(sizeof(lefiNoiseResistance *) * max);
...
lefiNoiseTable_newEdge(lefiNoiseTable * this)
{
  ...
  if (this->numEdges_ == this->edgesAllocated_) {
    ...
    lefiNoiseEdge **ne = (lefiNoiseEdge **) malloc(sizeof(lefiNoiseEdge *) * max);
...
lefiCorrectionResistance_Init(lefiCorrectionResistance * this)
{
  ...
  this->numVictims_ = 0;
  this->victimsAllocated_ = 2;
  this->victims_ = (lefiCorrectionVictim **) malloc(sizeof(lefiCorrectionVictim *) * 2);
}
					 ...
					 double d)
{
  ...
  if (this->numVictims_ == this->victimsAllocated_) {
    ...
    lefiCorrectionVictim **ne = (lefiCorrectionVictim **) malloc(sizeof(lefiCorrectionVictim *) * max);
...
lefiCorrectionEdge_Init(lefiCorrectionEdge * this)
{
  ...
  this->numResistances_ = 0;
  this->resistancesAllocated_ = 2;
  this->resistances_ = (lefiCorrectionResistance **) malloc(sizeof(lefiCorrectionResistance *) * 2);
}
...
lefiCorrectionEdge_addResistance(lefiCorrectionEdge * this)
{
  ...
  if (this->numResistances_ == this->resistancesAllocated_) {
    ...
    lefiCorrectionResistance **ne = (lefiCorrectionResistance **) malloc(sizeof(lefiCorrectionResistance *) * max);
...
lefiCorrectionTable_newEdge(lefiCorrectionTable * this)
{
  ...
  if (this->numEdges_ == this->edgesAllocated_) {
    ...
    lefiCorrectionEdge **ne = (lefiCorrectionEdge **) malloc(sizeof(lefiCorrectionEdge *) * max);
