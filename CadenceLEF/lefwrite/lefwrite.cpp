...
main(int argc, char** argv) {
  ...
  CHECK_STATUS(status);
  status = lefwRealPropDef("LAYER", "lrp", 0, 0, 0.0);
  CHECK_STATUS(status);
  status = lefwStringPropDef("VIARULE", "vrsp", 0, 0, NULL);
  CHECK_STATUS(status);
  status = lefwRealPropDef("VIARULE", "vrip", 0, 0, 0.0);
  CHECK_STATUS(status);
  ...
  CHECK_STATUS(status);
  status = lefwRealPropDef("NONDEFAULTRULE", "ndrrp", 0, 0, 0.0);
  CHECK_STATUS(status);
  ...
  status = lefwLayerRoutingPitch(1.8);
  CHECK_STATUS(status);
  status = lefwLayerRoutingSpacing(0.6, 1.1, 100.1);
  CHECK_STATUS(status);
  status = lefwLayerRoutingSpacingUseLengthThreshold();
  CHECK_STATUS(status);
  ...
  CHECK_STATUS(status);
  status = lefwLayerRoutingSpacingLengthThreshold(100.9);
  CHECK_STATUS(status);
  ...
  CHECK_STATUS(status);
  status = lefwMacroPinPortLayer("M1");
  CHECK_STATUS(status);
  ...
  status = lefwStartMacroPinPort(NULL);
  CHECK_STATUS(status);
  status = lefwMacroPinPortLayer("P1");
  CHECK_STATUS(status);
  ...
  status = lefwStartMacroPinPort(NULL);
  CHECK_STATUS(status);
  status = lefwMacroPinPortLayer("PC");
  CHECK_STATUS(status);
  ...
  status = lefwStartMacroPinPort(NULL);
  CHECK_STATUS(status);
  status = lefwMacroPinPortLayer("M2");
  CHECK_STATUS(status);
